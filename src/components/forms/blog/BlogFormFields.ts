export const blogFormFields = [
  { name: "title", label: "Title", placeholder: "Blog Post Title", required: true },
  { name: "summary", label: "Summary", type: "textarea" as const, placeholder: "Brief summary of the blog post", required: true },
  { name: "content", label: "Content", type: "textarea" as const, placeholder: "Full blog post content", required: true },
