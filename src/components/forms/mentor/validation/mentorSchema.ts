...
export const mentorRegistrationSchema = z.object({
  ...
  X_url: z.string().url("Invalid X URL").optional().nullable(),
  facebook_url: z.string().url("Invalid Facebook URL").optional().nullable(),
  instagram_url: z.string().url("Invalid Instagram URL").optional().nullable(),
  tiktok_url: z.string().url("Invalid TikTok URL").optional().nullable(),
  youtube_url: z.string().url("Invalid YouTube URL").optional().nullable(),
