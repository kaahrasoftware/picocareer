...
export function AnnouncementCard({ 
  ...
  return (
    <>
      <Card 
        className="bg-[#f3f3f3] hover:bg-[#eee] transition-all duration-200 border-gray-200 cursor-pointer"
            ...
            {announcement.image_url && (
              <div className="mt-6">
                <img 
                  src={announcement.image_url} 
                  alt="Announcement attachment" 
                  className="rounded-lg w-full max-h-[400px] object-contain bg-gray-50"
                />
              </div>
            )}
