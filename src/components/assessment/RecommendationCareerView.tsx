...
export const RecommendationCareerView = ({ recommendation, onBack }: RecommendationCareerViewProps) => {
  const navigate = useNavigate();
  const [showFindMentors, setShowFindMentors] = useState(false);

  const { relatedCareers, isLoading: relatedLoading } = useRelatedCareers(
