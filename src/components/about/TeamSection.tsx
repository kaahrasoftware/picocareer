  ...
  return <section className="pt-12">
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {teamMembers.map((member, index) => <Card key={index} className="transform transition-transform hover:scale-105">
              <CardHeader className="text-center pb-4">
                ...
                <div className="flex justify-center gap-4 mt-4">
                  {member.linkedin && <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-picocareer-primary transition-colors">
                      <Linkedin className="w-5 h-5" />
                    </a>}
                  {member.twitter && <a href={member.twitter} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-picocareer-primary transition-colors">
