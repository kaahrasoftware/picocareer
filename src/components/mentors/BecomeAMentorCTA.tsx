...
export function BecomeAMentorCTA() {
  return <Card className="mb-12 border-0 bg-gradient-to-r from-[#00A6D4]/5 to-[#33b3d9]/5 p-8 lg:p-12">
      <div className="flex flex-col lg:flex-row items-center gap-8">
        ...
        <div className="lg:flex-shrink-0">
          <Button asChild size="lg" className="bg-gradient-to-r from-[#00A6D4] to-[#0095c1] hover:from-[#0095c1] hover:to-[#008bb5] text-white font-semibold px-8 py-6 h-auto text-lg shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl group">
