  ...
  return <div className="mb-12 space-y-8">
      ...
      <Card className="p-6 border-0">
        ...
        <div className="flex flex-wrap gap-2">
          {topCompanies.map((company, index) => <span key={company} className="px-3 py-1 bg-[#00A6D4]/10 text-[#00A6D4] rounded-full text-sm font-medium">
              {company}
            </span>)}
          {companies.length > 8 && <span className="px-3 py-1 bg-gray-100 text-gray-600 rounded-full text-sm">
      ...
      <Card className="p-6 border-0">
        ...
        <div className="flex flex-wrap gap-2">
          {topCountries.map((country, index) => <span key={country} className="px-3 py-1 bg-[#33b3d9]/10 text-[#33b3d9] rounded-full text-sm font-medium">
              {country}
            </span>)}
          {countries.length > 12 && <span className="px-3 py-1 bg-gray-100 text-gray-600 rounded-full text-sm">
