...
export function ApplicationFormSection() {
  ...
  return (
    <section id="application-form" className="py-24 px-6 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      {/* Background elements */}
        ...
        {!showForm ? (
          <Card className="bg-white/95 backdrop-blur-xl border-0 shadow-2xl">
            ...
            <CardContent className="text-center">
              ...
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-semibold px-12 py-4 text-lg shadow-xl shadow-emerald-500/25 transition-all duration-300 hover:shadow-2xl hover:shadow-emerald-500/40 hover:scale-105 border-0"
