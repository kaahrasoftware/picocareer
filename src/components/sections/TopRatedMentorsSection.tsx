...
export const TopRatedMentorsSection = () => {
  ...
  if (isLoading) {
    return (
      <section className="py-16 bg-gradient-to-r from-[#00A6D4]/5 to-[#33b3d9]/5">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center">
              <div className="w-8 h-8 border-4 border-[#00A6D4] border-t-transparent rounded-full animate-spin"></div>
            </div>
    ...
    <section className="py-16 bg-gradient-to-r from-[#00A6D4]/5 to-[#33b3d9]/5">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-12">
          <Button asChild size="lg" className="group bg-[#00A6D4] hover:bg-[#0095c1] text-white">
