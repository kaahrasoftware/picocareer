  ...
  return <div className="space-y-4">
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <Select value={settings.profileVisibility} onValueChange={value => handleSelectChange('profileVisibility', value as 'public' | 'mentees' | 'private')}>
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch id="shareAvailability" checked={settings.shareAvailability} onCheckedChange={value => handleToggle('shareAvailability', value)} />
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch id="shareContactDetails" checked={settings.shareContactDetails} onCheckedChange={value => handleToggle('shareContactDetails', value)} />
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch id="allowPublicBooking" checked={settings.allowPublicBooking} onCheckedChange={value => handleToggle('allowPublicBooking', value)} />
        </div>
