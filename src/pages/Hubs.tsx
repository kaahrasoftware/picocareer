      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center space-y-6 mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Connect with institutions, find your perfect educational match, and join thriving academic communities.
          </p>
        ...
        {filteredHubs.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground mb-6">
              {searchQuery 
                ? `No hubs match your search for "${searchQuery}"`
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredHubs.map(hub => (
              <Card 
                key={hub.id} 
                className="group cursor-pointer transition-all duration-300 hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1 border-0 bg-card/80 backdrop-blur-sm overflow-hidden"
                    ...
                    <div className="relative -mt-8 shrink-0">
                      {hub.logo_url ? (
                        <img 
                          src={hub.logo_url} 
                          alt={`${hub.name} logo`} 
                          className="h-16 w-16 rounded-xl border-4 border-background bg-background object-cover shadow-lg" 
                        />
                      ) : (
                        <div 
                          className="h-16 w-16 rounded-xl border-4 border-background flex items-center justify-center shadow-lg"
                          style={{
