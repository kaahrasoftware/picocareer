    ...
    return (
      <div className="container mx-auto py-8">
        <Alert variant="destructive" className="mb-4">
          <AlertDescription>
            An error occurred while loading hubs. Please try again later.
          </AlertDescription>
        </Alert>
    ...
    <div className="container mx-auto py-8">
      ...
      {hubs && hubs.length === 0 ? (
        <div className="text-center py-12">
          <h2 className="text-xl font-medium mb-2">No hubs available</h2>
          <p className="text-muted-foreground">Create your first hub to get started!</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {hubs?.map((hub) => (
