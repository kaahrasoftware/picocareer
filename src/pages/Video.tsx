    ...
    <div className="flex justify-center items-center h-[calc(100vh-4rem)] bg-background overflow-hidden">
      <div className="relative w-full max-w-[400px] h-full bg-card rounded-lg overflow-hidden shadow-xl">
        ...
        <Button
          variant="ghost"
          size="icon"
          className="absolute top-4 left-1/2 -translate-x-1/2 z-10 rounded-full bg-background/20 hover:bg-background/40 backdrop-blur-sm"
        ...
        <Button
          variant="ghost"
          size="icon"
          className="absolute bottom-4 left-1/2 -translate-x-1/2 z-10 rounded-full bg-background/20 hover:bg-background/40 backdrop-blur-sm"
