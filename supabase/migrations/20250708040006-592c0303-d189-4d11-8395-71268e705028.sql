-- Phase 1: Database Schema Updates for Organization Portal

-- 1. Add organization-specific user roles to user_type enum
...
-- 2. Update RLS policies for api_organizations to allow self-creation
...
-- 3. Create or replace the handle_new_user function to support organization users
