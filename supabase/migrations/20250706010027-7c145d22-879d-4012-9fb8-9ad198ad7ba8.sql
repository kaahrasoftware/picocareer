...
-- Add missing columns to assessment_questions table with proper defaults
...
-- Clear existing questions to start fresh with the new profile-based structure
...
-- Add indexes for better performance on conditional queries
